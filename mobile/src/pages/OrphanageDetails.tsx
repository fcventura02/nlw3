...
interface OrphanegeDetailsRouteParams {
  id: number,
}

export default function OrphanageDetails() {
  const route = useRoute();
  const params = route.params as OrphanegeDetailsRouteParams
  const [orphanage, setOrphanage] = useState<OrphanegeItem>();
  ...
  function handleOpenGoogleMapRoutes() {
    Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${orphanage?.latitude},${orphanage?.longetude}`)
  }
